defmodule Kamajii.Application do
  @moduledoc false
  ...
  def start(_type, _args) do
    ...
    children = [
      {Kamajii.API, [cleartext_options]},
      {Kamajii.API, [secure_options]}
    ]

    opts = [strategy: :one_for_one, name: Kamajii.Supervisor]
  ...
  defp certificate_path() do
    Application.app_dir(:kamajii, "priv/localhost/certificate.pem")
  end

  defp certificate_key_path() do
    Application.app_dir(:kamajii, "priv/localhost/certificate_key.pem")
  end
end
